...
if(EXISTS "C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt" AND EXISTS "C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitinfo.txt" AND
  ...
  message(VERBOSE
    ...
    "'C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt'"
  )
  return()
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-src'")
endif()
...
while(error_code AND number_of_tries LESS ${max_tries})
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external"
    RESULT_VARIABLE error_code
    ${maybe_show_command}
  )
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: 'C:/Users/ama5185/Desktop/Martin/RPG/rpg-mazmorras/external/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt'")
endif()
